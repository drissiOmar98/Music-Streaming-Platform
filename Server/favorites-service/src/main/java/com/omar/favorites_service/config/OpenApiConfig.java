package com.omar.favorites_service.config;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Favourite Service API",
                version = "1.0",
                description = "API documentation for the Favourite Service of the Spotify Clone project.",
